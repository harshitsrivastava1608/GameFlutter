...
class _TextFieldAlertDialogState extends State<TextFieldAlertDialog> {
  TextEditingController _textFieldController1 = TextEditingController();TextEditingController _textFieldController2 = TextEditingController();
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(alignment:Alignment.topCenter,child: Text("TIC-TAC-TOE",style: TextStyle(fontSize: 30.0,fontWeight: FontWeight.bold,color: Colors.amber),)),
          Container(
            alignment: Alignment.bottomCenter,
            child: ElevatedButton(
              style: ButtonStyle(backgroundColor:MaterialStateProperty.all(Colors.yellow),fixedSize: MaterialStateProperty.all(Size(300, 100)) ),
              child: Text(
                'Getting Started',
